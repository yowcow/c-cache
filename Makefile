...
$(RESOURCES)/libhash.so: $(BUILD)/pair.o $(BUILD)/hash-node.o $(BUILD)/hash-bucket.o $(BUILD)/hash.o
	$(CC) $(OPT) -shared -I murmurhash.c murmurhash.c/murmurhash.c \
		$(BUILD)/pair.o $(BUILD)/hash-node.o $(BUILD)/hash-bucket.o $(BUILD)/hash.o \
...
test: all $(BUILD)/pair-test $(BUILD)/hash-node-test $(BUILD)/hash-bucket-test $(BUILD)/hash-test
	./$(BUILD)/pair-test
	./$(BUILD)/hash-node-test
	./$(BUILD)/hash-bucket-test
	./$(BUILD)/hash-test

test-valgrind: all $(BUILD)/pair-test $(BUILD)/hash-node-test $(BUILD)/hash-bucket-test $(BUILD)/hash-test
	valgrind ./$(BUILD)/pair-test
	valgrind ./$(BUILD)/hash-node-test
	valgrind ./$(BUILD)/hash-bucket-test
	valgrind ./$(BUILD)/hash-test

$(BUILD)/pair-test: $(BUILD)/pair.o
	$(CC) $(OPT) \
		$(BUILD)/pair.o \
		pair-test.c -o $(BUILD)/pair-test

$(BUILD)/hash-node-test: $(BUILD)/hash-node.o
	$(CC) $(OPT) \
		$(BUILD)/pair.o $(BUILD)/hash-node.o \
		hash-node-test.c -o $(BUILD)/hash-node-test

$(BUILD)/hash-bucket-test: $(BUILD)/hash-bucket.o
	$(CC) $(OPT) \
		$(BUILD)/pair.o $(BUILD)/hash-node.o $(BUILD)/hash-bucket.o \
